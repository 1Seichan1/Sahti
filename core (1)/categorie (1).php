<?PHP
    ...
    include_once 'E:/xampp/htdocs/weeebbb/sahti/Entities/categorie.php';
...
if(isset($_POST["cat"]))
{
    ...
    $categorie= new categorie($_POST["cat"]);
...
<label for="cat">ajouter categorie:</label>
...
<div class="col-lg-4">
			...
			while ($row = mysqli_fetch_assoc($result)) {
				echo "<tr><td>"
				.$row["cat"]."</td><tr>"
				."<td><a href='updatecat.php?id=".$row["id"]."'>modifier<a></td>"
				."<td><a href='deletecat.php?id=".$row["id"]."'>supprimer<a></td>";
			}
